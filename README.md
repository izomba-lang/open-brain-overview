...
- **Gmail** — важные тредки синхронизируются
...
- `countries/egypt.md` — всё что знаешь про египетский рынок
- `people/kholodnov.md` — история взаимодействия с человеком
- `topics/personal-finance.md` — налоги, опционы, финплан
...
- `?что я решил по Египту` — поиск по базе
- `/today` — план на день из задач и встреч
- `/call позвони в клинику и запиши на приём` — голосовой агент

**Через AI-клиент (Claude Desktop / Cursor):**
- "Подготовь бриф к встрече с Alshaya" — `route_task` найдёт skill `meeting-brief`
- "Что я знаю про налоги в Израиле?" — `search_thoughts` по базе
- "Добавь Казахстан в wiki" — `manage_wiki_entity` + `compile_wiki`
- "Прикрепи финмодель к Alshaya" — `manage_artifact`
